        ...
        <div class="container h-100">
                <div class="dplay-tbl">
                        <div class="dplay-tbl-cell center-text color-white pt-90">
                                <h5><b>Contact</b></h5>
                                <h3 class="mt-30 mb-15">Cirebon Food</h3>
                        </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
        </div><!-- container -->
</section>
...
<section class="story-area left-text center-sm-text">
        <div class="container">
                <?php
                        ...
                        {
                               echo '<script type="text/javascript">alert("Pesan tidak dikirim.");</script>'; 
                        }
                        else
                        {
                ...
                ?>
                <div class="heading">
                        <h2>Hallo Cirebon Food</h2>
                        <!-- <h5 class="mt-10 mb-30">Say hello, send us a message</h5> -->
                        <p class="mx-w-700x mlr-auto">Form dibawah disediakan untuk pelanggan yang ingin mengirim keluhan atau reward kepada restoran Cirebon Food. Apabila dalam pelayanan kami tidak memuaskan atau ada kesalahan, kami segenap keluarga besar Cirebon Food memohon maaf sebesar-besarnya.</p>
                </div>

                <form class="form-style-1 placeholder-1" method="post" action="proses_kirim_pesan.php" enctype="mulipart/form-data">
                        <div class="row">
                                <div class="col-md-6"> <input class="mb-20" type="text" placeholder="Nama" name="nama">  </div>
                                <div class="col-md-6"> <input class="mb-20" type="text" placeholder="E-mail" name="email">  </div>
                                <div class="col-md-12"><input class="mb-20" type="text" placeholder="Judul" name="judul">  </div>
                                <div class="col-md-12">
                                        <textarea class="h-200x ptb-20" placeholder="Pesan" name="pesan"></textarea></div>
                        </div><!-- row -->
                        <div class="col-md-12">
                                <hr>
