...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div>
              <h1>Data Menu</h1>
              <a href="form_tambah_menu.php">Tambah Data</a><br><br>
  ...
  // Load file koneksi.php
          ...
          $query = "SELECT * FROM makanan"; // Query untuk menampilkan semua data siswa
          ...
          while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
            ...
            echo "<td><a href='form_ubah_menu.php?id_makanan=".$data['id_makanan']."'>Ubah</a></td>";
            echo "<td><a href='proses_hapus_menu.php?id_makanan=".$data['id_makanan']."'>Hapus</a></td>";
            echo "</tr>";
          }
          ?>
          </table>
