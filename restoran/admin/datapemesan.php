...
<body>
  ...
  // Load file koneksi.php
          ...
          $query = "SELECT * FROM reservasi WHERE status='menunggu'"; // Query untuk menampilkan semua data siswa
          ...
          while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
            ...
            echo "<td><a href='proses_status_diterima.php?Id_reservasi=".$data['Id_reservasi']."'>Diterima</a></td>";
