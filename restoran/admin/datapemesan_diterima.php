...
<body>
  ...
  // Load file koneksi.php
          ...
          $query = "SELECT * FROM reservasi WHERE status='diterima' or status= 'sudah bayar'"; // Query untuk menampilkan semua data siswa
          ...
          while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
            ...
            echo "<td><a href='proses_status_bayar.php?Id_reservasi=".$data['Id_reservasi']."'>Sudah Bayar</a></td>";
            echo "<td><a href='proses_status_ditolak.php?Id_reservasi=".$data['Id_reservasi']."'>Ditolak</a></td>";
            echo "</tr>";
          }
          ?>
          </table>
