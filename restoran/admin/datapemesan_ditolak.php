...
<body>
  ...
  // Load file koneksi.php
          ...
          $query = "SELECT * FROM reservasi WHERE status='ditolak'"; // Query untuk menampilkan semua data siswa
          ...
          while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
            ...
            echo "<td><a href='proses_hapus_datapesan.php?Id_reservasi=".$data['Id_reservasi']."'>Hapus</a></td>";
            echo "</tr>";
          }
          ?>
          </table>
