...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h3>Halaman Admin</h3>
            <p>Halaman ini di peruntukan untuk admin Cirebon Food. Disini admin dapat menambahkan, menghapus dan mengubah data menu. Admin juga bisa melihat data reservasi, data komentar dan yang terakhir bisa menambahkan data admin yang lain.</p>
        </div>
    </div>
