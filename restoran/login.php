...
<html lang="en">
<head>
	<title>Halaman Login Admin Cirebon Food</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('web/login/images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				?>
				<form method="post" action="cek_login.php" class="login100-form validate-form p-b-33 p-t-5">
